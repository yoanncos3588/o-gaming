...
function CreateIssue() {
    ...
    useEffect(() => {
        getPlatforms(`${import.meta.env.VITE_API_URL}/platforms`, 'platforms');
        getTags(
    ...
    useEffect(() => {
        if (isCompleteIssue) {
            navigate(`/game/${idGame}?toast=issueCreated`);
        }
    }, [isCompleteIssue, navigate, idGame]);
